  ...
  return Container(
    ...
    child: Row(
      children: [
        Expanded(
          flex: 2,
          child: paintBoatBucket(context, 
            model.userBoats, 
            model.onAcceptBoatInBucket, model.isBoatAcceptableInBucket)
        ),
        Expanded(
          flex: 8,
          child: paintGrid(context, 
            model.placedBoats,
            model.onAcceptBoatInGrid, model.isBoatAcceptableInGrid)
        ),
      ],
    ),
  );
...
paintBoatBucket(BuildContext context, List<Boat> userBoats, 
...
paintGrid(BuildContext context, 
